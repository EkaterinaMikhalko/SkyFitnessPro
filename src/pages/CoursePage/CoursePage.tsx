    ...
    <div className="mx-[140px] my-[60px]">
      ...
      <div className="w-[1160px] h-[310px] flex flex-row justify-between rounded-[20px]  bg-[#ffc700]">
        ...
        <div className="pt-[60px] gap-x-[3.75rem]">
            ...
            <div className="w-[431px] h-[141px] bg-black text-white  p-[17px] rounded-[20px]">
              <div className="flex flex-row">
                ...
                <div className="text-[24px]">
                  Хотите укрепить позвоночник, избавиться <br/> от болей в спине и
                  суставах
                </div>
              </div>
            </div>
          ...
          <div className="">
            <div className="bg-[#FFFFFF] rounded-[20px] w-[1160px] h-[486px] shadow-2xl mt-[72px]">
              <h1 className="w-[398px] h-[120px]">Начните путь <br/>к новому телу</h1>
              <div className="">
                <ul className="">
                ...
                {/* <svg src="./images/courseBeginning"></svg> */}
              </div>
            </div>
          </div>
        </div>
